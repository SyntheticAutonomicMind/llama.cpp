...
public:
    ...
    // attention cache on qwen4exp (QSA) models. without this, save/restore
    // "mirrored slot layout holds N cells, this cache restores M" because the
    // indexer still has stale cells beyond the logical end of the restored
    // state.
