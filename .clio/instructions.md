...
2. For any unstaged or staged files, check session history to learn what was being done with them.
...
# If handoff directory appears:
git reset HEAD [handoff-dir]/
...
*For technical reference (code style, testing, module structure, project conventions), see AGENTS.md.*
